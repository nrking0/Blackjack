    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/nrking0/Code/cinder_0.9.2_mac/my-projects/final-project/cmake-build-debug/_deps/catch2-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/nrking0/Code/cinder_0.9.2_mac/my-projects/final-project/cmake-build-debug/_deps/catch2-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
